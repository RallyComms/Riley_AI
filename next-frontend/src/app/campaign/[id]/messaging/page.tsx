    ...
    <div className="relative flex h-full min-h-0 bg-[#f7f5ef]">
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        <header className="flex items-end justify-between border-b border-[#e5ddce] px-6 py-5 lg:px-8">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-[#1f2a44]">Messaging</h1>
            <p className="mt-1 text-sm text-[#6f788a]">
              Develop and review campaign messaging with a clear workflow.
            </p>
          </div>
          <button
            ...
            aria-controls="messaging-riley-panel"
          >
          ...
          <div className="flex h-full flex-col">
            ...
            <div className="border-b border-[#e5ddce] bg-white/80 px-4 py-3">
              <p className="text-sm leading-relaxed text-[#1f2a44]">
                Welcome to Riley Messaging. I can help you analyze messaging strategy, review documents connected to this tab, and sharpen message development. I&apos;m getting much stronger in Riley V2.
              </p>
            </div>
