      ...
      <section className="rounded-2xl border border-[#e2d8c4] bg-[#fbf8f1] p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-[#1f2a44]">Insights & Intelligence</h1>
            <p className="mt-1 max-w-3xl text-sm text-[#6f788a]">
              Global cross-campaign intelligence surface for strategist and admin teams. Compare momentum, track
              issue movement, and prioritize intervention where signal risk is rising.
            </p>
